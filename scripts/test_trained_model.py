...
Examples:
python -u /scr2/zhaoyang/condBFNPol/scripts/test_trained_model.py \
        ...
        --batch-size 64 \
        --device cuda \
        --vis-dir /scr2/zhaoyang/test_bfn/diffusion \
        --output-json /scr2/zhaoyang/test_bfn/diffusion/diffusion.json


python -u /scr2/zhaoyang/condBFNPol/scripts/test_trained_model.py \
        --checkpoint /scr2/zhaoyang/bfn_real_pusht.ckpt \
        ...
        --batch-size 64 \
        --device cuda \
        --vis-dir /scr2/zhaoyang/test_bfn/bfn \
        --output-json /scr2/zhaoyang/test_bfn/bfn/bfn.json

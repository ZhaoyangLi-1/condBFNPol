...
# Minimal Disk Usage Benchmark - All Seeds (42, 43, 44)
# 
# This version maximizes disk savings while still running all seeds:
# - Checkpoints only at epochs 100, 200, 300 (final)
# - Keeps only top-1 checkpoint per run
# - Uses scratch directory
# - WandB offline mode
...
echo "MINIMAL DISK USAGE - ALL SEEDS"
echo "======================================"
